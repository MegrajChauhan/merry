...
//
// /**
//  * When two processes are communicating via MerryOWC, a copy is given to each
//  of
//  * the process. One process should only listen by closing it's write line
//  while
//  * the other should only speak by closing the read line. If both processes
//  need
//  * to speak and listen, two OWC can be created. Or, in our case, we will
//  create
