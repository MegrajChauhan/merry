...
_MERRY_DEFINE_FUNC_PTR_(mresult_t, mcorecreate_t, MerryCoreState *, MerryCoreIdentity ,
                        maddress_t , mptr_t *);
...
void merry_register_core(mcore_t type,mcorecreate_t ccreate,mcoredeletecore_t cdel,mcoreexec_t cexec,mcorepredel_t cpredel,mcoresetinp_t csetinp,mcoreprepcore_t cprepc,mcoreconfig_t cconf, mcorehelp_t chelp);

mresult_t merry_init_request(MerryGravesRequest **req, mcond_t *cond, mbool_t async);

mresult_t merry_set_request_CREATE_CORE(MerryGravesRequest *req, mcore_t new_core_type, maddress_t st_addr,mguid_t gid);
mresult_t merry_set_request_CREATE_GROUP(MerryGravesRequest *req);

mresult_t merry_get_request_result_CREATE_CORE(MerryGravesRequest *req, msize_t *id, msize_t *uid);
mresult_t merry_get_request_result_CREATE_GROUP(MerryGravesRequest *req, msize_t *gid);
